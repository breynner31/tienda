    ...
    <center>
        <main>
            <div class="container">
                ...
                <div class="row">
                    <div  class="button">
                       <button> <a href="WxQ7N9WEqxxcpk2ho9mhc4JQJGPOyUAIbfjCUEW2k75gsn5XskV2nX4i6nKi" class="btn btn-primary btn-lg"> Realizar pagos</a> </button>
                    </div>
                </div>
                <?php }?>
            </div>
      ...
      eliminaModal.addEventListener('show.bs.modal',function(event){
        ...
        function actualizaCantidad($cantidad, $_id) {
            ...
            fetch(url, {
                ...
                .then(data => {
                    if (data.ok) {
                        let divsubtotal = document.getElementById('' + $_id)
